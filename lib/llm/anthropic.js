...
// changes over time. This default follows the "claude-<tier>-<version>"
// naming current as of this writing (2026-08-15); if calls start failing
// with a model-not-found error, set ANTHROPIC_MODEL in Vercel rather than
// editing this file. Check https://docs.claude.com/en/docs/about-claude/models
// for the current fast/cheap tier's exact slug.
