...
// getOrganicCompetitors(domain, opts) -> Promise<Array<{domain, keywordsCommon, keywordsTarget, keywordsCompetitor, share, domainRating}>>
...
//
// Returns [] -- never throws -- on a missing API key, missing domain, or
// any failure, same "data gap, not a fabricated result" contract as every
// other function here.
async function getOrganicCompetitors(domain, { apiKey, limit = 20, country = null } = {}) {
  if (!apiKey || !domain) return []
