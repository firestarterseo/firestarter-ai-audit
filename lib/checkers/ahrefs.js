...
// indistinguishable from "the API call is silently failing" (wrong plan
// tier for this specific report, a bad param, a transient error) -- a real
// difference to a strategist that a flat empty array can't communicate.
