...
async function main() {
  ...
  console.log('\n' + '='.repeat(70))
  console.log('CASE 5: REAL live capture -- all 5 engines (chatgpt, google, gemini,')
  console.log('perplexity, copilot) via Cloro Playground, 2026-08-10. This is the')
  console.log('actual, fully-verified real-world run.')
  console.log('='.repeat(70))
