...
async function main() {
  ...
  // exercises: URL-pattern (high confidence, e.g. /about/) and, indirectly,
  // that every record has all four fields populated.
  ...
  assert.strictEqual(byPathFull['/blog/example/'].classificationSource, 'url_pattern')
