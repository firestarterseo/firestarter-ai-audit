...
// extractEngineSignal exported 2026-08-15 for lib/serpLandscape.js -- it
// needs the SAME verified google-shape parsing (organicResults[].link,
// localResults[].links.website, optional aioverview.citationPills) to
// pull real ranking domains for keyword-opportunity candidates, and
// re-deriving that parsing in a second file would risk quietly drifting
// from the shape this file already fixed and verified against a real
// live capture (see this file's 2026-08-10 status note above).
module.exports = { checkAiVisibilitySnapshot, defaultCloroCaller, extractEngineSignal, scoreToGrade, DEFAULT_ENGINES, ENGINE_WEIGHTS }
