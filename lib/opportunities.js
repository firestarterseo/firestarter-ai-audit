...
// annotation, lib/keywordDifficulty.js's real-Keyword-Difficulty
...
// realisticTier/tierReason/tierSource, plus the raw serpTopDomains/
// keywordDifficulty evidence) ride along into `detail` so
// OpportunitiesManager.js can show them. Absent entirely when refinement
// didn't run or failed (llmRefined: false) -- same graceful-degradation
// contract as the rest of this feature; the UI just shows less, never
// stale/wrong enrichment data.
function keywordOpportunitiesToItems(keywordOpportunities) {
  return (keywordOpportunities || []).map(o => ({
    ...
    detail: {
      ...
      ...(o.keywordDifficultyChecked ? { keywordDifficulty: o.keywordDifficulty } : {}),
      ...(o.llmRefined ? {
